...
public class LzWeiMember implements java.io.Serializable {
	...
	private String wmbType_Q;//会员类型
	private String wmbName_Q;//会员名称
	private String wmbMobule_Q;//手机号
	
	private String[] wmbIds;
	private Integer ShopAdminId_Q;
	private Integer wmbWcsId_Q;
	...
	@Transient
	public Integer getShopAdminId_Q() {
		return ShopAdminId_Q;
	}

	public void setShopAdminId_Q(Integer shopAdminId_Q) {
		ShopAdminId_Q = shopAdminId_Q;
	}
	@Transient
	public Integer getWmbWcsId_Q() {
		return wmbWcsId_Q;
	}

	public void setWmbWcsId_Q(Integer wmbWcsId_Q) {
		this.wmbWcsId_Q = wmbWcsId_Q;
	}
