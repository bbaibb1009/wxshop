...
<html>
  ...
  <body>
  	...
  	<div class="content">
  	<f:form action="${pageContext.request.contextPath}/goods/addGoodsFenlei" onsubmit="return false;">
  	<f:hidden path="wgfWcsId"/>
 	<table cellpadding="0" cellspacing="0" border="1" width="100%">
    	<tr><th width="8%">分类名称</th><td><f:input path="wgfName"/></td></tr>
   		<tr><td colspan=2><input type="button" value="添加" onclick="javascript:addGoodsFenlei();"/></td></tr>
    </table>
    </f:form>
    </div>
    </div>
