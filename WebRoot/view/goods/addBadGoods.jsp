...
<html>
  ...
  <body>
 	...
 	<table cellpadding="0" cellspacing="0" border="1" width="100%">
 		...
 		<tr><th width="8%">坏账商品</th><td>${goods.wgsName}</td></tr>
    	<tr><th width="8%">坏账时间</th><td><f:input path="wgoOutTime" onfocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" cssClass="Wdate" cssStyle="cursor: pointer;"/></td></tr>
    	<tr><th width="8%">坏账量</th><td><f:input path="wgoOutNum"/></td></tr>
    	<tr><th width="8%">处理价</th><td><f:input path="wgoOutPrice"/></td></tr>
    	<tr><th width="8%">备注</th><td><f:textarea path="wgoDesc"/></td></tr>
   		<tr><td colspan=2><input type="button" value="坏账" onclick="javascript:addOutGoods();"/></td></tr>
    </table>
    </f:form>
    </div>
    </div>
