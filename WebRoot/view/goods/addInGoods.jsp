...
<html>
  ...
  <body>
  	...
  	<div class="content">
  	<f:form action="${pageContext.request.contextPath}/goods/addInGoods" onsubmit="return false;">
  	<f:hidden path="wgiWgsId"/>
  	<f:hidden path="wgiWcsId"/>
 	<table cellpadding="0" cellspacing="0" border="1" width="100%">
 		<tr><th width="8%">入库商品</th><td>${goods.wgsName}</td></tr>
    	<tr><th width="8%">入库时间</th><td><f:input path="wgiInTime" onfocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" cssClass="Wdate" cssStyle="cursor: pointer;"/></td></tr>
