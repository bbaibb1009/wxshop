...
function initEditor(t){
	KindEditor.ready(function(K) {
		window.editor1 = K.create('textarea[name="'+t+'"]',{
			width : '100%',
			height: '300px',	
			uploadJson:path+'/view/js/kindEditor/jsp/upload_json.jsp',
			fileManagerJson:path+'/view/js/kindEditor/jsp/file_manager_json.jsp',
			allowFileManager:true,
			items:['source','fullscreen','lineheight', 'undo', 'redo', 'cut', 'copy', 'paste','plainpaste', 'wordpaste', '|',
					 ...
					 'table','image', 'advtable', 'hr', 'link', 'unlink' ],
