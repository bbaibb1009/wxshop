      ...
      <div class="widget-box">
          ...
          <div class="widget-content ">
            ...
            <div class="form-group">
            	<label for="wsaUsername" class="col-lg-1 control-label">名称</label>
            	<div class="col-lg-3">
               	 	<f:input path="wdpName" cssClass="form-control input-ms"/>
                </div>
            </div>
            <div class="form-group">
            	<label for="wsaUsername" class="col-lg-1 control-label">级别</label>
            	<div class="col-lg-3">
            ...
            <div class="form-group">
            	<label for="wsaUsername" class="col-lg-1 control-label">顺序</label>
            	<div class="col-lg-3">
            ...
            <div id="pdept2" class="form-group " style="display: none;">
            	<label for="wsaName" class="col-lg-1 control-label"><font color="red"><b>*</b></font>上级部门：</label> 
            	<div class="col-lg-3">
