          ...
          <div class="widget-content ">
          	<f:form action="${pageContext.request.contextPath}/wxmsg/addWxMsg" cssClass="form-horizontal" onsubmit="return false;">
	        	<div class="form-group">
            		<label for="wsaUsername" class="col-lg-1 control-label">所属APPID</label>
            		<div class="col-lg-3">
               	 		<f:input path="wmgAppId" 		cssClass="form-control input-ms"/>
                	</div>
            	</div>
	            <div class="form-group">
	            	<label for="wsaUsername" class="col-lg-1 control-label">回复内容</label>
	            	<div class="col-lg-3">
	               	 	<f:input path="wmgContent" 		cssClass="form-control input-ms"/>
	                </div>
	            </div>
	            <div class="form-group">
	            	<label for="wsaUsername" class="col-lg-1 control-label">回复内容XML</label>
	            	<div class="col-lg-3">
	               	 	<f:input path="wmgContentXml" 	cssClass="form-control input-ms"/>
	                </div>
	            </div>
	            <div class="form-group ">
	            	<label for="wsaName" class="col-lg-1 control-label">回复类型</label> 
	            	<div class="col-lg-3">
	                	<f:input path="wmgReplyType" 	cssClass="form-control input-ms"/>
	            	</div>
	            </div>
	            <div class="form-group">
	            	<label for="wsaSex" class="col-lg-1 control-label">消息类型</label> 
	            	<div class="col-lg-3">
	                	<f:input path="wmgMsgType" 		cssClass="form-control input-ms"/>
	            	</div>
	            </div>
	            <div class="form-group">
	            	<label for="wsaSex" class="col-lg-1 control-label">加密类型</label> 
	            	<div class="col-lg-3">
	            		<f:input path="wmgAesType" 		cssClass="form-control input-ms"/>
	            	</div>
	            </div>
				<div class="form-group">
