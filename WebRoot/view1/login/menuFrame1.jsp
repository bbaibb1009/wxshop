...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="f"%>
		<div class="top">
			...
			您好，<a href="${pageContext.request.contextPath}/admin/showMyInfo/0">${adminInfoShop.wsaName}</a>&nbsp;&nbsp;&bull;&nbsp;
			...
			<a href="${pageContext.request.contextPath}/admin/adminLogout">退出</a>
		</div>
		...
		<div class="nav" id="adminTop">
			...
			<a href="#" onclick="showAdminMenu2(${menu1.WSM_ID}, this);return false;" ${menu1Class}>${menu1.WSM_NAME }</a>
			</c:forEach>
		</div>
		...
		<div class="admin_left" id="adminLeft">
			...
			<ul class="menu" id="${menu1.WSM_ID }" ${menu1Display}>
				<c:forEach var="menu2" items="${adminMenusLevel2Cust}">
				<c:if test="${menu2.WSM_PARENT_ID == menu1.WSM_ID}">
				<li>&raquo;&nbsp;<a href="javascript: showAdminMenu3(${menu1.WSM_ID }, ${menu2.WSM_ID });">${menu2.WSM_NAME }</a>
					...
					<ul id="${menu2.WSM_ID }" ${menu2Display}>
						...
						<li>&rsaquo;&nbsp;<a href="javascript: goUrl(${menu3.WSM_ID }, '${menu3.WSM_URL }');" ${menu3Class }>${menu3.WSM_NAME }</a></li>
						</c:if>
						</c:forEach>
					</ul>
				</li>
