...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="首页" class="tip-bottom"><i class="icon-home"></i>首页</a> <a href="#" class="current">404</a> </div>
    <h1>Error 404</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="error_ex">
              ...
              <h3>对不起，当前页面不存在.</h3>
              <p>没有找到您想去的地方.</p>
              <a class="btn btn-warning btn-big"  href="${pageContext.request.contextPath}/admin/adminLoginSuccess">去首页</a> </div>
          </div>
        </div>
      </div>
    </div>
